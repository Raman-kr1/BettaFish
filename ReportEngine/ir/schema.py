...
This module centralizes all chapter-level Schema definitions and their text
representations for use in prompts, ensuring chapter generation, validation,
and rendering share a unified understanding of the structure.
"""
        ...
        {"type": "string"},
        {
            ...
            "properties": {
                ...
                "impact": {
                    "type": "string",
                    "enum": ["低", "中低", "中", "中高", "高", "极高"],
                    "description": "Impact rating, only allowed values: 低/中低/中/中高/高/极高 (Low/Medium-Low/Medium/Medium-High/High/Very High)",
                },
                # "score": {
                #     "type": "number",
                #     "minimum": 0,
                #     "maximum": 10,
                #     "description": "Score, only numbers from 0-10 allowed",
                # },
        ...
        {"type": "string"},
        {
            ...
            "properties": {
                ...
                "trend": {
                    ...
                    "description": "Trend/impact assessment, only allowed values: 正面利好/负面影响/中性/不确定/持续观察 (Positive/Negative/Neutral/Uncertain/Under Observation)",
                },
...
pest_block: Dict[str, Any] = {
    ...
    "properties": {
        ...
        "political": {
            ...
            "description": "Political factors: policies and regulations, government stance, political stability, etc.",
        },
        "economic": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
            "description": "Economic factors: economic cycles, interest rates and exchange rates, consumption levels, etc.",
        },
        "social": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
            "description": "Social factors: demographics, cultural trends, lifestyles, etc.",
        },
        "technological": {
            "type": "array",
            "items": {"$ref": "#/definitions/pestItem"},
            "description": "Technological factors: technological innovation, R&D investment, technology adoption, etc.",
        },
    },
    "required": ["type"],
    "anyOf": [
