        ...
        try:
            ...
            for i, paragraph in enumerate(report_structure):
                if not isinstance(paragraph, dict):
                    logger.warning(f"Paragraph {i+1} is not a dictionary format, skipping")
                    continue
        ...
        return [
            {
                ...
                "content": "Provide overall overview and analysis of the query topic"
            },
            {
                "title": "In-depth Analysis",
                "content": "Deeply analyze various aspects of the query topic"
            }
        ]
