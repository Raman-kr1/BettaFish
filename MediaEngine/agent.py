...
class DeepSearchAgent:
    ...
    def execute_search_tool(self, tool_name: str, query: str, **kwargs) -> BochaResponse:
        ...
        Args:
            tool_name: Tool name, available options:
                ...
                - "search_last_24_hours": Latest info within 24 hours
                - "search_last_week": This week's info
            query: Search query
    ...
    def _initial_search_and_summary(self, paragraph_index: int):
        ...
        # Handle special parameters (new toolset doesn't need date parameter handling)
        search_kwargs = {}
        ...
        if search_response and search_response.webpages:
            # Each search tool has its specific result count, here we cap at 10
            ...
            for result in search_response.webpages[:max_results]:
                search_results.append({
                    ...
                    'score': None,  # Bocha API doesn't provide score
...
class AnspireSearchAgent(DeepSearchAgent):
    ...
    def execute_search_tool(self, tool_name: str, query: str, **kwargs) -> AnspireResponse:
        # TODO: Execute search using Anspire search tool
        """
        Execute specified search tool
