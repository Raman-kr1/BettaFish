...
class LLMClient:
    ...
    def stream_invoke(self, system_prompt: str, user_prompt: str, **kwargs) -> Generator[str, None, None]:
        """
        Stream invoke LLM, returning response content incrementally
    ...
    def stream_invoke_to_string(self, system_prompt: str, user_prompt: str, **kwargs) -> str:
        """
        Stream invoke LLM and safely concatenate to complete string (avoiding UTF-8 multi-byte character truncation)
