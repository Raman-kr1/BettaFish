...
Responsible for formatting final research results into a well-formatted Markdown report
"""
...
class ReportFormattingNode(BaseNode):
    ...
    def process_output(self, output: str) -> str:
        """
        Process LLM output, clean up Markdown format
    ...
    def format_report_manually(self, paragraphs_data: List[Dict[str, str]], 
        ...
        """
        Manually format report (backup method)
        ...
        try:
            ...
            if len(paragraphs_data) > 1:
                report_lines.extend([
                    "## Conclusion",
                    "",
                    "This report provides a comprehensive analysis of the related topics through deep search and research. "
                    "The content in each section above provides important references for understanding this topic.",
                    ""
                ])
